...
class condGANTrainer(object):
    ...
    def save_img_results(self, netG, noise, w_sent_emb, w_words_embs,
        ...
        fake_img, _, _ = nn.parallel.data_parallel(netG, (real_imgs[-1], w_sent_emb, w_words_embs, noise, mask, enc_features), self.gpus)
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                fake_img, mu, logvar = nn.parallel.data_parallel(netG, (imgs[-1], w_sent_emb, w_words_embs, noise, mask, enc_features), self.gpus)
                ...
                netG.zero_grad()
                errG_total, G_logs = \
                    generator_loss(netD, fake_img, imgs[-1], w_imgs[-1], real_labels, w_sent_emb, VGG, self.gpus)
                ...
                if gen_iterations % 1000 == 0:
                    ...
                    load_params(netG, avg_param_G)
                    self.save_img_results(netG, fixed_noise, w_sent_emb,
                                          w_words_embs, captions, wrong_caps, gen_iterations, imgs, mask, VGG)
                    load_params(netG, backup_para)
