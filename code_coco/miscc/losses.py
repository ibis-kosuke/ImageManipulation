...
def discriminator_loss(netD,  real_imgs, fake_imgs, sent_emb, w_sent_emb,
    ...
    D_logs = 'errD:%.2f errD_c:%.2f ' % (errD, errD_c)
...
def generator_loss(netD, fake_img, real_img, w_img, real_labels, sent_emb, VGG, gpus):
