...
def parse_args():
    ...
    parser.add_argument('--gpu', dest='gpu_ids', type=str, default='0,1')
    parser.add_argument('--data_dir', dest='data_dir', type=str, default='')
    parser.add_argument('--manualSeed', type=int, help='manual seed')
    parser.add_argument('--netG', type=str, default='birds_EncDecModel_2021_01_01_14_46_59')
    parser.add_argument('--netG_epoch', type=str, default='netG_epoch_600.pth')
...
def gen_example(wordtoix, algo, imsize, image_transform, norm, data_dir):
    ...
    with open(filepath, "r") as f:
        ...
        for name in filenames:
            ...
            #img_name = name.replace("hand_made_text", "images")
            img_name = name.replace("hand_made_text", "train/train2014")
...
if __name__ == "__main__":
    ...
    output_dir = '%s/output/%s_%s_%s' % \
        (cfg.DATA_DIR, cfg.DATASET_NAME, cfg.CONFIG_NAME, timestamp)
